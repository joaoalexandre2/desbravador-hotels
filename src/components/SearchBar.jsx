...
//       <span>{label}</span>
//       <div>
//         <button onClick={(e) => { e.stopPropagation(); onMinus(); }}>−</button>
//         <span>{value}</span>
//         <button onClick={(e) => { e.stopPropagation(); onPlus(); }}>+</button>
//       </div>
//     </div>
//   );
// }
